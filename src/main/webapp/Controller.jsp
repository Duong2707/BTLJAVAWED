...
<section class="events-section">
    ...
    <div class="event-button">
        <a href="NewController" class="see-more-btn">XEM THÊM </a>
    </div>
</section>
...
<script>
    ...
    function sendMessage() {
      ...
      // Làm trống ô nhập liệu sau khi gửi
      messageInput.value = "";

      // Cuộn xuống tin nhắn mới
      chatBody.scrollTop = chatBody.scrollHeight;

      // Gửi phản hồi từ admin (giả lập)
      setTimeout(() => {
        const adminMessage = document.createElement('div');
        adminMessage.classList.add('message', 'admin');
        adminMessage.textContent = "Admin: Cảm ơn bạn đã liên hệ, tôi sẽ trả lời sớm nhất.";
        chatBody.appendChild(adminMessage);

        // Cuộn xuống tin nhắn mới
        chatBody.scrollTop = chatBody.scrollHeight;
      }, 2000); // Phản hồi sau 2 giây
    }
  </script>
